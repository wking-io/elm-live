...
`
${header}
  ${chalk.blue.bold('Hot Reloading is ON')}

  Hot Reloading swaps your compiled Elm code without reloading the page, preserving the
  state of the app.

  ${chalk.yellow.bold('Warning')}: Hot Reloading does not replay the messages of the app but just
  saves and restores the state. This may bring the app to a wrong state. If this happen, reload the app in the browser manually.
`

...
const getSourceDirs = require('./src/get-source-dirs')
...
test('gets watched paths from the Elm package file', assert =>
  new Promise(resolve => {
    ...
    testSourceDirs('lib/test/0.18.0', ['src18/**/*.elm', '../elsewhere18/src/**/*.elm'])

    testSourceDirs('lib/test/0.19.0', ['src19/**/*.elm', '../../elsewhere19/**/*.elm'])

    testSourceDirs('lib/test', ['**/*.elm'])

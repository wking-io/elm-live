...
import { HeadingOne, Body, Code, HeadingLinkBase, Wrapper, CodeBlock, HeadingTwo } from './elements'

const GettingStarted = ({ location }) => {
  const HeadingLink = HeadingLinkBase(location)
  return (
    <Wrapper>
      <HeadingLink linkId='getting-started'><HeadingOne id='getting-started'>Getting Started</HeadingOne></HeadingLink>
      <CodeBlock>
      ...
      <HeadingLink linkId='getting-started-cmd'><HeadingTwo id='getting-started-cmd'># elm-live</HeadingTwo></HeadingLink>
      <Body>This is the name of the binary that is installed either to your local or global path.</Body>
      <HeadingLink linkId='getting-started-file'><HeadingTwo id='getting-started-file'># &lt;elm-file&gt;</HeadingTwo></HeadingLink>
      ...
      <HeadingLink linkId='getting-started-file-extra'><HeadingTwo id='getting-started-file-extra'># [other-elm-files]</HeadingTwo></HeadingLink>
      ...
      <HeadingLink linkId='getting-started-flags'><HeadingTwo id='getting-started-flags'># [flags]</HeadingTwo></HeadingLink>
      ...
      <HeadingLink linkId='getting-started-elm-make'><HeadingTwo id='getting-started-elm-make'># [--] [elm make flags]</HeadingTwo></HeadingLink>

  ...
  return (
    <Layout>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-4"><strong>Default: false</strong></p>
        <p className="leading-relaxed mb-4">The <code>--proxy-prefix</code> flag tells the server what path to capture and point to the server located at <code>--proxy-host</code>. It requires the <code>--proxy-host</code> flag and should be a string like <code>/api</code>. </p>
        <p className="leading-relaxed mb-12"><strong>NOTE:</strong> The string passed to <code>--proxy-prefix</code> will be removed from the <code>--proxy-host</code> url. If you would like the url to include the prefix just add it there as well like: http://localhost:5000/api.</p>
